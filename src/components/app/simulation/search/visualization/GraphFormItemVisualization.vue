<template>
    <svg :width="size" :height="size" viewBox="0 0 90 90">
        ...
        <rect x="20" y="0" width="50" height="20" class="selectable" :class="hasConnections ? (!props.item.data().connections.top ? 'border' : 'blank') : 'none' + (props.readOnly ? '' : ' hoverable')" @click="toggleConnection('top')"/>
        ...
        <rect x="70" y="20" width="20" height="50" class="selectable" :class="hasConnections ? (!props.item.data().connections.right ? 'border' : 'blank') : 'none' + (props.readOnly ? '' : ' hoverable')" @click="toggleConnection('right')"/>
        ...
        <rect x="20" y="70" width="50" height="20" class="selectable" :class="hasConnections ? (!props.item.data().connections.bottom ? 'border' : 'blank') : 'none' + (props.readOnly ? '' : ' hoverable')" @click="toggleConnection('bottom')"/>
        ...
        <rect x="0" y="20" width="20" height="50" class="selectable" :class="hasConnections ? (!props.item.data().connections.left ? 'border' : 'blank') : 'none' + (props.readOnly ? '' : ' hoverable')" @click="toggleConnection('left')"/>
