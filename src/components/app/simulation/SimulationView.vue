<template>
    <FColumn :grow="true" class="bg-white" :class="{ 'fixed top-0 left-0 bottom-0 right-0 p-1 z-10': fullScreen }" :justifyItems="fullScreen ? 'end' : 'start'" @keydown.esc="fullScreen = false">
